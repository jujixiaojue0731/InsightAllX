...
intent: Add a bounded redacted diagnostics trace for ACP bridge events and renderer image-projection decisions so insightAllX can diagnose ACP image rendering failures without modifying insightAll.
touchedAreas:
