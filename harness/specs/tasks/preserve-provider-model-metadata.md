...
acceptance:
  ...
  - Newly created runtime model rows receive input metadata matching insightAll custom-provider onboarding inference.
...
- Mirror insightAll onboarding's custom-model image-input inference for new model
  IDs.
