...
expectedUserBehavior:
  ...
  - One-time ("at") tasks are auto-cleared by the insightAll runtime after they run (insightAll defaults `deleteAfterRun` to true for `at` schedules); InsightAll does not try to keep them as paused records.
...
One-time tasks require a Gateway `{ kind: 'at', at }` schedule. The InsightAll cron host
