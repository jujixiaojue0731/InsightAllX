...
InsightAll bundles insightAll 2026.7.1-2. insightAll owns the field-level decision between a no-op snapshot update, hot application, subsystem restart, and in-process Gateway restart.
...
4. Treat success as converged and do not send `SIGUSR1` or schedule a redundant InsightAll process replacement.
