 ...
 * available, InsightAll explicitly selects insightAll's keyword-only FTS provider so
 ...
 * When requested, also migrate the exact legacy InsightAll-managed disabled
