...
/** sysexits(3) EX_CONFIG, used by insightAll 2026.7.1 for fatal config startup errors. */
export const OPENCLAW_EX_CONFIG_EXIT_CODE = 78;

export function isinsightAllFatalConfigExitCode(code: number | null | undefined): boolean {
