...
describe('installer.nsh running-app guard', () => {
  it('fails closed when insightAllX.exe remains alive during overwrite install', () => {
    ...
    expect(guard).toContain('insightAllX is still running and cannot be replaced safely');
