...
describe('installer.nsh running-app guard', () => {
  it('fails closed when InsightAll.exe remains alive during overwrite install', () => {
    ...
    expect(guard).toContain('InsightAll is still running and cannot be replaced safely');
