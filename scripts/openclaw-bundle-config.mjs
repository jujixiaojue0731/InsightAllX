export const EXTRA_BUNDLED_PACKAGES = [
  ...
  // insightAll package's own transitive dependency graph, but are required in
  ...
  // bundled insightAll context in packaged builds. Package it explicitly so
  ...
  // insightAll's built-in browser extension resolves playwright-core at runtime.
  ...
  // bundled insightAll runtime context in packaged builds.
  'qrcode-terminal',
];
