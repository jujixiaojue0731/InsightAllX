#!/usr/bin/env node
/**
 * Generates extension bridge files based on insightall-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'insightall-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure insightall-extensions.json and link the package.',
