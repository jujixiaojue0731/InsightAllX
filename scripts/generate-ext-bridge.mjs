#!/usr/bin/env node
/**
 * Generates extension bridge files based on insightallx-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'insightallx-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure insightallx-extensions.json and link the package.',
