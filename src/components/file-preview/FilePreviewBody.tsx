          ...
          <div className="space-y-1.5">
            ...
            {allowSystemActions && <p className="max-w-md text-xs leading-relaxed text-muted-foreground">
              {t(
                ...
                'insightAllX cannot read this path. The file may have been moved, deleted, or may not be accessible to the current account. You can inspect it in your file manager.',
              )}
            </p>}
          </div>
          {allowSystemActions && <Button variant="outline" size="sm" onClick={handleOpenInFinder}>
