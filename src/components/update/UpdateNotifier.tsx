...
const AVAILABLE_TOAST_ID = 'insightall-update-available';
const DOWNLOADED_TOAST_ID = 'insightall-update-downloaded';
 ...
 * Sonner toast (`UpdateToast`) that follows the active InsightAll theme.
 */
