...
const AVAILABLE_TOAST_ID = 'insightallx-update-available';
const DOWNLOADED_TOAST_ID = 'insightallx-update-downloaded';
 ...
 * Sonner toast (`UpdateToast`) that follows the active insightAllX theme.
 */
